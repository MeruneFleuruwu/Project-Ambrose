...
[![Contributor track](https://img.shields.io/badge/open%20items-75-5FD3C4?labelColor=131B31)](doc/CONTRIBUTOR-TRACK.md)
...
| | |
|---|---|
| **75 open items** | [doc/CONTRIBUTOR-TRACK.md](doc/CONTRIBUTOR-TRACK.md) - F-01 to F-55 for proven findings, C-01 to C-75 for tools, data, schemas, fixtures, guides and proposals |
