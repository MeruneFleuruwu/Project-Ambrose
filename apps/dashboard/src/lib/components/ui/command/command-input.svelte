<!-- Project Ambrose by Imjustchico: The command input part of the command component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
