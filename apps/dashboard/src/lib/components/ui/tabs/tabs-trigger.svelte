<!-- Project Ambrose by Imjustchico: The tabs trigger part of the tabs component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
