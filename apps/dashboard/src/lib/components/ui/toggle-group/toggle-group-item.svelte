<!-- Project Ambrose by Imjustchico: The toggle group item part of the toggle group component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
