<!-- Project Ambrose by Imjustchico: The table head part of the table component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
