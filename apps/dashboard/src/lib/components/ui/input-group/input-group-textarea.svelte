<!-- Project Ambrose by Imjustchico: The input group textarea part of the input group component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
