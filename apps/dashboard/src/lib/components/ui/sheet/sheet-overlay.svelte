<!-- Project Ambrose by Imjustchico: The sheet overlay part of the sheet component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
