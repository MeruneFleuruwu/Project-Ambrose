<!-- Project Ambrose by Imjustchico: The avatar group count part of the avatar component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
