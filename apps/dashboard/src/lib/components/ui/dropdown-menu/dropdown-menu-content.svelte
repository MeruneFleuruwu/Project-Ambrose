<!-- Project Ambrose by Imjustchico: The dropdown menu content part of the dropdown menu component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
