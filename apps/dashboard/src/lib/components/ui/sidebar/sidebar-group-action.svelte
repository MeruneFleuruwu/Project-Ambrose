<!-- Project Ambrose by Imjustchico: The sidebar group action part of the sidebar component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
