<!-- Project Ambrose by Imjustchico: The select content part of the select component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
