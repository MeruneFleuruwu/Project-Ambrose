<!-- Project Ambrose by Imjustchico: The card header part of the card component from shadcn-svelte, copied in and owned, styled from the panel stylesheet's theme variables. -->
<script lang="ts">
