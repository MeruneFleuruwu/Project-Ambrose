<!-- Project Ambrose by Imjustchico: The overview of the app that served the panel, read live: headline figures and a card with its state, place, uptime, build, sessions, memory, threads and tick times, badges and problems with the button that fixes each where the build reports the problem, every figure carrying the age of its sample and demoted once it goes stale, and the last fifteen minutes of what it reports over time. -->
<script lang="ts">
